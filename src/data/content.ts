...
export const projects: Project[] = [
  {
    ...
    slug: 'jameson',
    title: 'Jameson',
    description: 'OOH installation featuring a monumental barrel man.',
    label1: 'OOH',
    label2: '3D Modelling',
    duration: '2 Months',
    date: 'September 2024',
  ...
  },
  {
    ...
    slug: 'martell',
    title: 'Martell',
    description: 'OOH installation at Lagos most trafficked roundabout.',
    label1: 'OOH',
    label2: '3D Modelling',
    duration: '2 Months',
    date: 'June – July 2023',
  ...
  },
  {
    ...
    slug: 'duskline',
    title: 'Duskline',
    description: 'Brand identity for record shop and bar.',
  ...
  },
  {
    ...
    slug: 'verdant',
    title: 'Verdant',
    description: 'Brand identity for Portland specialty coffee.',
    label1: 'Cafe',
    label2: 'Branding',
    duration: '4 Weeks',
