  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-8 items-stretch lg:items-stretch w-full" style={{ gap: 'clamp(24px, 5vw, 40px)' }}>
        ...
        <div className="w-full lg:w-1/2 relative flex-shrink-0 lg:h-full" style={{ height: 'clamp(350px, 70vw, 700px)' }}>
          <div className="relative w-full h-full rounded-2xl overflow-hidden" style={{ borderRadius: '16px' }}>
            <Image
              src="/me.jpg"
              alt="Let's Connect"
              fill
