    ...
    <div className="h-screen overflow-hidden bg-[#15222c] p-[8px] sm:p-[12px] flex flex-col animate-fadeIn">
      ...
      >
        ...
        <div className="absolute top-1/2 lg:top-32 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:translate-y-0 text-center px-4 sm:px-6 md:px-8 w-full">
          <div className="text-white leading-tight sm:leading-snug md:leading-normal lg:leading-relaxed lg:mt-0">
            <div
              className="text-[clamp(2.5rem,6vw,4rem)] lg:text-6xl font-bold text-white font-['Libre_Baskerville',serif] leading-none lg:leading-tight transition-opacity duration-700"
              style={{ opacity: activeChar === 1 ? 1 : 0 }}
            >
              Creative Designer
            </div>
            <div
              className="text-[clamp(1rem,3vw,1.5rem)] lg:text-2xl font-light font-['Jost',sans-serif] mt-3 lg:mt-2 transition-opacity duration-700"
              style={{ opacity: activeChar === 1 ? 1 : 0, color: '#d0dadf' }}
            >
              crafting visual stories that inspire and engage.
            </div>
            <button
              onClick={() => navigate('/creative-designer')}
              className="apple-glass-button mt-6 px-4 py-2 sm:px-5 sm:py-[8.6px] md:px-6 md:py-[9.6px] rounded-[16px] sm:rounded-[18px] md:rounded-[20px] text-sm sm:text-base font-['Jost',sans-serif] font-medium transition-opacity duration-700 cursor-pointer flex items-center gap-1.5 sm:gap-2 mx-auto"
              style={{ opacity: activeChar === 1 ? 1 : 0 }}
            >
