      ...
      <section className="content-layer flex-1">
        ...
        {slug === 'mielo' && (
          <>
            ...
            <div className="hidden md:flex w-full h-[calc(100dvh-var(--nav-h))] flex-col gap-4 relative miela-hero-in" onTouchStart={onMieloTouchStart} onTouchMove={(e)=>e.preventDefault()} onTouchEnd={onMieloTouchEnd}>
            ...
            <div className="md:hidden w-full h-[calc(100dvh-var(--nav-h))] flex flex-col gap-4 relative miela-hero-in" onTouchStart={onMieloTouchStart} onTouchMove={(e)=>e.preventDefault()} onTouchEnd={onMieloTouchEnd}>
              {/* Image container: 65% height with 9 frames */}
              <div className="h-[65%] px-[clamp(12px,3vw,24px)] flex items-center justify-center relative">
                {/* All 9 image frames stacked */}
              ...
              {/* Navigation dots in the gap */}
              <div className="absolute left-0 right-0 flex justify-center pointer-events-none" style={{ top: 'calc(65% + 8px)', zIndex: 20 }}>
                <div className="mielo-gap-dots flex justify-center gap-2">
                  {Array.from({ length: TOTAL_MIELO_FRAMES }).map((_, idx) => (
                    <div key={idx} className={`dot ${mieloFrame === idx ? 'active' : ''}`} />
                  ))}
              ...
              {/* Content container: 35% height */}
              <div className="h-[35%] px-[clamp(12px,3vw,24px)] mb-[clamp(12px,3vw,24px)] flex items-center justify-center">
                {/* Add content here */}
              </div>
            </div>
          </>
