  ...
  return (
    <div className="min-h-screen bg-[#06080a] p-[clamp(12px,3vw,24px)] lg:p-[clamp(6px,1.5vw,12px)] animate-fadeIn relative flex flex-col">
      ...
      >
        ...
        <div className="hidden lg:flex w-full justify-center mt-10 mb-6">
          <button
            ...
            className="case-study-btn px-4 py-2 sm:px-5 sm:py-[8.6px] md:px-6 md:py-[9.6px] rounded-full text-sm sm:text-base text-white font-['Jost',sans-serif] font-medium transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2"
          >
      ...
      <style>{`
        ...
        /* Creative theme Case Study button - glow-only (moving shine), no solid fill */
        .case-study-btn {
          position: relative;
          overflow: hidden;
          background: transparent; /* no solid fill */
          border: 1.5px solid rgba(122, 31, 43, 0.8); /* wine red edge */
        ...
        .case-study-btn:active {
          /* Fill with wine red on hover/click */
          background: linear-gradient(135deg, #7a1f2b 0%, #6a1a25 50%, #7a1f2b 100%);
          border-color: #7a1f2b;
          color: #ffffff;
        }
